...
_ _ _
**This is a near exact replica of the [Rickshaw getting started tutorial](http://code.shutterstock.com/rickshaw/tutorial/introduction.html) built using the R packages [slidify](http://slidify.org) and [rCharts](http://github.com/ramnathv/rCharts).  All credit and attribution should be directed to the original authors.  See the copyright at the end of this page.**   
- - -
...
<br/>
> To keep the code focused on the charts and not the data, we will use .csv files as our data source for the rest of the examples.  To see this tutorial with the data specified in R, go to this [version](http://timelyportfolio.github.io/rCharts_rickshaw_gettingstarted/index_dataspecified.html).
